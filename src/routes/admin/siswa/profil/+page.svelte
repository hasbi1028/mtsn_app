<script lang="ts">
	...
	import { submitPerubahanC, uploadFoto, getCurrentSiswaQ } from '$modules/siswa/siswa.remote';

	const profile = $derived(await getCurrentSiswaQ() as any);
