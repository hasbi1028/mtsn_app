<script lang="ts">
	...
	import { getCurrentSiswaQ } from '$modules/siswa/siswa.remote';

	const siswa = $derived(await getCurrentSiswaQ() as any);
...
<div class="flex flex-col gap-4">
	...
	<Card.Root>
		<Card.Header>
			...
			<Card.Description>Informasi Bantuan Sosial Siswa</Card.Description>
		</Card.Header>
		<Card.Content>
			{#if siswa}
				<div class="mb-3">
					<a
						href="/admin/siswa/bansos/cetak"
						target="_blank"
			...
			{:else}
				<div class="flex flex-col items-center gap-3 py-6">
					...
					<p class="text-sm text-muted-foreground text-center">Data siswa tidak ditemukan.</p>
				</div>
			{/if}
		</Card.Content>
	</Card.Root>
