...
export const ROUTE_RULES: RouteRule[] = [
	...
	{ prefix: '/admin/berita', roles: ['admin', 'kepsek', 'guru'] },
	{ prefix: '/admin/pengumuman', roles: ['admin', 'kepsek', 'guru'] },
	{ prefix: '/admin/agenda', roles: ['admin', 'kepsek', 'guru'] },
	{ prefix: '/admin/galeri', roles: ['admin', 'kepsek', 'guru'] },
	{ prefix: '/admin/prestasi', roles: ['admin', 'kepsek', 'guru'] },
	{ prefix: '/admin/ekskul', roles: ['admin', 'kepsek', 'guru'] },
